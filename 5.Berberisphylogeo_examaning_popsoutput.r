...
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/AllLoci/BerAll/out.noreplicates/batch_1.sumstats.tsv"),
  npop=9, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"))                  
SNPFis.plots(popsumstats=popsumstats)

## HitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerAll/out.noreplicates/batch_1.sumstats.tsv"),
  npop=9, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"))                  
SNPFis.plots(popsumstats=popsumstats)

## NohitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/NohitGP/BerAll/out.noreplicates/batch_1.sumstats.tsv"),
  npop=9, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"))                  
SNPFis.plots(popsumstats=popsumstats)
...
## AllLoci
# load Stacks output file with populations summary statistics 
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/AllLoci/BerwoOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=8, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"))                  
SNPFis.plots(popsumstats=popsumstats)

## HitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerwoOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=8, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"))                  
SNPFis.plots(popsumstats=popsumstats)

## NohitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/NohitGP/BerwoOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=8, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"))                  
SNPFis.plots(popsumstats=popsumstats)
...
## AllLoci
# load Stacks output file with populations summary statistics 
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/AllLoci/woZaOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=7, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)

## HitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/HitGP/HitGP/woZaOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=7, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)

## NohitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/NohitGP/woZaOut/out.noreplicates/batch_1.sumstats.tsv"),
  npop=7, popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)
...
## AllLoci
# load Stacks output file with populations summary statistics 
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/AllLoci/BerSS/out.noreplicates/batch_1.sumstats.tsv"),
  npop=6, popNames=c("Aj","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)

## HitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerSS/out.noreplicates/batch_1.sumstats.tsv"),
  npop=6, popNames=c("Aj","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)

## NohitGP
popsumstats <-read.sumstats(file=paste0(WD,Popoutsfolder,"/NohitGP/BerSS/out.noreplicates/batch_1.sumstats.tsv"),
  npop=6, popNames=c("Aj","Iz","Ma","Pe","Tl","To"))                  
SNPFis.plots(popsumstats=popsumstats)
...
####### BerAll
## AllLoci
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/AllLoci/BerAll/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"),
  outgroup= "OutBtAl214")

## HitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerAll/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"),
  outgroup= "OutBtAl214")

## NohitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/NohitGP/BerAll/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za","Out"),
  outgroup= "OutBtAl214")

####### BerwoOut
## AllLoci
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/AllLoci/BerwoOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"),
  outgroup= "ZaB06")

## HitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerwoOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"),
  outgroup= "ZaB06")

## NohitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/NohitGP/BerwoOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To","Za"),
  outgroup= "ZaB06")

####### woZaOut
## AllLoci
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/AllLoci/woZaOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"),
  outgroup= "AnB01")

## HitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/HitGP/HitGP/woZaOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"),
  outgroup= "AnB01")

## NohitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/NohitGP/woZaOut/out.noreplicates/plink.raw"),
  popNames=c("Aj","An","Iz","Ma","Pe","Tl","To"),
  outgroup= "AnB01")

####### BerSS
## AllLoci
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/AllLoci/BerSS/out.noreplicates/plink.raw"),
  popNames=c("Aj","Iz","Ma","Pe","Tl","To"),
  outgroup= "PeB01")

## HitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/HitGP/HitGP/BerSS/out.noreplicates/plink.raw"),
  popNames=c("Aj","Iz","Ma","Pe","Tl","To"),
  outgroup= "PeB01")

## NohitGP
infoPCATree(plinkfile = paste0(WD,Popoutsfolder,"/NohitGP/BerSS/out.noreplicates/plink.raw"),
  popNames=c("Aj","Iz","Ma","Pe","Tl","To"),
  outgroup= "PeB01")
